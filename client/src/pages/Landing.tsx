      ...
      <section className="py-28 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="relative overflow-hidden rounded-3xl border border-orange-500/20 p-10 md:p-14 text-center" style={{ background: "linear-gradient(135deg, rgba(249,115,22,0.06) 0%, rgba(0,0,0,0) 60%)" }}>
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500 text-black text-[11px] font-black uppercase tracking-widest mb-4">
              ⚡ 50% OFF — Limited Time
            </div>
            ...
            <div className="flex items-baseline justify-center gap-3 mb-8">
              <span className="text-4xl font-extrabold text-gray-600 line-through" style={{ fontFamily: "var(--font-display)" }}>€4.99</span>
