          ...
          {selectedId ? (
            ...
            <motion.div key="list" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
              <div className="mb-10">
                ...
                <div className="mt-3 flex items-center gap-2 px-4 py-2.5 bg-orange-500/10 border border-orange-500/30 rounded-xl w-fit">
                  <Zap className="w-4 h-4 text-orange-400 shrink-0" />
                  <span className="text-sm font-black text-orange-300">Premium is currently <span className="text-orange-400">50% off</span> — Limited time sale!</span>
                </div>
              </div>
