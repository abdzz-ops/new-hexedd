...
import { ArrowLeft, Check, ShoppingBag, Star, ExternalLink } from "lucide-react";
...
const PRODUCTS = [
  {
    ...
    bgColor: "#1e1040",
    accentColor: "#9333ea",
    description: "Unlock everything Voidlink has to offer.",
    features: [
      "Remove Voidlink watermark from your profile",
  ...
  },
  {
    ...
    bgColor: "#1c1200",
    accentColor: "#f59e0b",
    description: "Show your richness on Voidlink.",
    features: [
      "Show your richness with the rich badge",
      "Support Voidlink with your contribution",
  ...
  },
  {
    ...
    bgColor: "#0f1622",
    accentColor: "#94a3b8",
    description: "Support Voidlink and show your appreciation.",
    features: [
      "Silver Donator badge on your profile",
      "Support Voidlink development",
  ...
  },
  {
    ...
    bgColor: "#1a0a10",
    accentColor: "#ec4899",
    description: "Show your love for Voidlink.",
    features: [
...
function ProductCard({ product, owned, onClick }: { product: typeof PRODUCTS[0]; owned: boolean; onClick: () => void }) {
  return (
    <motion.div
      ...
      style={{ borderColor: owned ? product.accentColor + "66" : undefined }}
    >
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-0 rounded-2xl overflow-hidden border border-white/10">
        ...
        <div className="bg-[#0c0c0c] p-8 flex flex-col">
          ...
          <div className="text-4xl font-black mt-4 mb-6" style={{ color: product.accentColor }}>
          ...
          {owned ? (
            ...
            <div className="space-y-3">
              <div className="p-3 rounded-xl border border-yellow-500/20 bg-yellow-500/5 flex items-start gap-3">
                ...
                <p className="text-[11px] text-yellow-400/80">A <strong>Voidlink account</strong> is required to purchase this product!</p>
              </div>
    ...
    <div className="min-h-screen bg-[#050505] text-white">
      <header className="border-b border-white/[0.04] bg-[#050505]/90 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          <a href="/" className="text-xl font-black text-orange-500 tracking-tighter">Voidlink</a>
          ...
          {selectedId ? (
            ...
            <motion.div key="list" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
              <div className="mb-10">
                ...
                <p className="text-gray-500 text-sm">Enhance your Voidlink profile with exclusive badges and features.</p>
              </div>
